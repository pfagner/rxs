...
IMPORT_LIBS="${CODE_COPY_SRC}/scripts/cli/import_libs.sh"
# Installation files
INSTALL_FILE="${CODE_COPY_SRC}/scripts/cli/install.sh"
CONFIG_SRC="${CODE_COPY_SRC}/config"
SCRIPTS_SRC="${CODE_COPY_SRC}/scripts"

EXE_FILE="rxsc"
EXE_FILE_SRC="${BUILD_DIR}/tools/client/${EXE_FILE}"
EXE_FILE_DST="${BUILD_DIR}/${EXE_FILE}"

# Compose paths for archive
BUILD_FILES="${BUILD_FILES}${EXE_FILE}"
##########################################################################
#
##########################################################################
# Copy src code
